...
class EntradaController extends Controller
{
    ...
    {   
        /*Utilizando politicas
        El metodo cant se utiliza para verificar
        si el usuario tiene incapacidad de ejecutar 
        una determinada accion
        Este metodo recibe la politica y el objeto afectado
        ...
        /*Utilizando el Gate 
        El usuario se inyecta implicitamente*/
